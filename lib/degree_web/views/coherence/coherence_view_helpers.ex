defmodule DegreeWeb.Coherence.ViewHelpers do
  @moduledoc """
  ...
  For example, to generate links in your layout template use:
      DegreeWeb.Coherence.ViewHelps.coherence_links/3
  ...
  @seperator {:safe, "&nbsp; | &nbsp;"}
  @helpers DegreeWeb.Router.Helpers
  ...
  * :register - customize the register link text (#{@register_link_text})
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DegreeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DegreeWeb.Gettext, "errors", msg, opts)
    end
  end
